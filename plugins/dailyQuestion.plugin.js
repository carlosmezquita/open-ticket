...
function sendRandomDailyQuestion(channel) {
    ...
    const randomIndex = Math.floor(Math.random() * questions.read_questions.length);
    const randomQuestion = questions.read_questions[randomIndex];
    ...
    questions.read_questions.splice(randomIndex, 1);
    questions.unread_questions.push(randomQuestion);
